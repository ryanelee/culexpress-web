    ...
    .controller('BillingReportCtrl', ['$scope', '$compile', '$timeout', '$state', '$stateParams', 'settlementSvr', '$filter', 'SweetAlert',
        function ($scope, $compile, $timeout, $state, $stateParams, settlementSvr, $filter, SweetAlert) {
            ...
            var loadUnpaid = function () {
                settlementSvr.getUnpaid($scope.$root.currentUser.customerNumber)
                .then(function (result) {
                    if (!!result.data) {
            ...
            var loadReportExcelData = function () {
                ...
                settlementSvr.getExcelList($scope.$root.currentUser.customerNumber)
                .then(function (result) {
            ...
            var loadInstructionData = function () {
                settlementSvr.instruction($scope.$root.currentUser.customerNumber)
                .then(function (result) {
            ...
            $scope.loadHistoryList = function (index) {
                ...
                settlementSvr.getPaymentHistory(index, $scope.$root.currentUser.customerNumber)
                .then(function (result) {
