    ...
    .service('receiptService', ["$http", function ($http) {
        ...
        self.mapping = {
            sendType: function (sendType) {
                var _sendType = "";
                switch (sendType) {
                    case 1: _sendType = "寄送库存"; break;
                    case 2: _sendType = "海淘包裹"; break;
                }
                return _sendType;
            },
            type: function (type) {
                var _type = "";
                switch (type) {
                    case 1: _type = "无预报记录"; break;
                    case 2: _type = "物品损坏"; break;
                    case 3: _type = "错送"; break;
                    case 4: _type = "少送"; break;
                    case 5: _type = "多送"; break;
                    case 6: _type = "其他"; break;
                }
                return _type;
            },
            status: function (status) {
                var _status = "";
                switch (status) {
                    case 1: _status = "未解决"; break;
                    case 2: _status = "已关闭"; break;
                    case -1: _status = "已删除"; break;
                }
                return _status;
            }
        }
