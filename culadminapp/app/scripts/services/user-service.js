...
angular.module('culAdminApp')
    .service('userService', ["$http", "$rootScope", "$location", function ($http, $rootScope, $location) {
        ...
        self.login = function (userInfo, callback) {
            ...
            $http.post(cul.apiPath + "/user/login", bodyData).then(success,fail).then(function (result) {
        ...
        self.addUser = function (userInfo, callback) {
            $http.post(cul.apiPath + "/user", userInfo).then(function (result) {
        ...
        self.update = function (userInfo, callback) {
            $http.put(cul.apiPath + "/user", userInfo).then(function (result) {
                callback(result.data);
            });
        }
        ...
        self.delete = function (ids, callback) {
            $http.delete(cul.apiPath + "/user?userIds=" + ids, {}).then(function (result) {
                callback(result.data);
            });
        }
        ...
        self.resetPassword = function (options, callback) {
            ...
            $http.put(cul.apiPath + "/user/password/reset/default", bodyData).then(function (result) {
                callback(result.data);
            });
        }
        ...
        self.getList = function (options, callback) {
            $http.post(cul.apiPath + "/user/list", options).then(function (result) {
                callback(result.data);
            });
        }
        ...
        self.getDetail = function (role_id, callback) {
            $http.get(cul.apiPath + "/user/" + role_id).then(function (result) {
                callback(result.data);
            });
        }
