...
/** 
 * @ngdoc function
 * @name culAdminApp.controller:FinanceOutCtrl
 * @description
 * # FinanceOutCtrl
 * Controller of the culAdminApp
 */
angular.module('culAdminApp')
    .controller('FinanceWarehousePayCtrl', ['$window', '$rootScope', '$scope', '$location', 'warehouseService', 'orderService', 'plugMessenger',
        function($window, $rootScope, $scope, $location, warehouseService, orderService, plugMessenger) {
            ...
            $('#tip_batchOutbound').popover({
                ...
                trigger: 'hover',
                title: '',
                content: "点击此按钮将修改包裹状态为已出库，打包记录将自动从上面的列表中消失。"
            });
        }
    ]);