...
/**
 * @ngdoc function
 * @name culAdminApp.controller:FinanceDetailRechargeLogsCtrl
 * @description
 * # FinanceDetailRechargeLogsCtrl
 * Controller of the culAdminApp
 */
angular.module('culAdminApp')
    .controller('FinanceDetailRechargeLogsCtrl', ["$scope", "$location", "$filter", "customerService", "settlementService", "plugMessenger",
