...
/**
 * @ngdoc directive 
 * @name culAdminApp.directive:printflyingExpressNew
 * @description
 * # printflyingExpressNew
 */
angular.module('culAdminApp')
  .directive('printFlyingExpressNew', ["$timeout", "warehouseService", function ($timeout, warehouseService) {
      return {
          templateUrl: "views/templates/common/print-flyingexpress-new_tpl.html",
          restrict: 'E',
          replace: true,
          scope: true,
          link: function postLink($scope, $element, attrs) {
              ...
              $scope.$on("print-flying-express-new.action", function (e, orderNumbers) {
